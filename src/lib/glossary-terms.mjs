...
const CORE_GLOSSARY_TERMS = [
	...
	},
	{
		...
		slug: 'iptu',
		definition:
			'Imposto Predial e Territorial Urbano, administrado pela Prefeitura de Balneário Camboriú (PMF). Durante a obra, a responsabilidade pelo pagamento deve constar no contrato; após a entrega, passa a ser do proprietário da unidade.',
	},
	{
	...
	},
	{
		...
		definition:
			'Variação de demanda e preços de locação conforme a estação, comum em bairros litorâneos de Balneário Camboriú. No verão, a procura por imóveis de curta temporada tende a subir.',
	},
	{
		term: 'Bairros em expansão',
		slug: 'bairros-em-expansao',
		definition:
			'Regiões de Balneário Camboriú com obras de infraestrutura, novos acessos e entrada de incorporadoras. Costumam oferecer condições comerciais atrativas na planta e potencial de valorização conforme o bairro amadurece.',
	},
	{
		term: 'Grande Balneário Camboriú',
		slug: 'grande-balneario-camboriu',
		definition:
	...
	},
	{
		...
		slug: 'registro-de-imoveis-balneario-camboriu',
		definition:
			'Cartórios responsáveis pela matrícula e registro das unidades na capital (1º e 2º RI de Balneário Camboriú). Após habite-se e quitação, a unidade comprada na planta é registrada em nome do comprador.',
	},
	{
		term: 'Outorga onerosa do direito de construir',
		slug: 'outorga-onerosa-balneario-camboriu',
		definition:
