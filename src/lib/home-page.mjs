...
const FALLBACK_NEIGHBORHOOD_IMAGES = [
	'/assets/img/gallery/gallery-1-1.webp',
	'/assets/img/gallery/gallery-1-2.webp',
	'/assets/img/gallery/gallery-1-3.webp',
	'/assets/img/gallery/gallery-1-4.webp',
	'/assets/img/gallery/gallery-1-5.webp',
	'/assets/img/gallery/gallery-1-6.webp',
];
...
export function getHomePageShell() {
	...
	const before = (
		...
		'data-bg-src="/assets/img/hero/hero_bg_1_1.webp"',
