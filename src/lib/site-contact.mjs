...
export const SITE_PRODUCTION_URL = 'https://balneario.vivercatarina.com';
export const SITE_LOCAL_URL = 'http://localhost:4321';

const isLocalDev =
	process.env.NODE_ENV === 'development' ||
	(typeof import.meta !== 'undefined' && import.meta.env?.DEV);

export const SITE_URL = isLocalDev ? SITE_LOCAL_URL : SITE_PRODUCTION_URL;
...
export const SITE_LOCATION = 'Balneário Camboriú, SC';
export const SITE_CITY = 'Balneário Camboriú';
export const SITE_DEFAULT_DESCRIPTION =
	'Portal Viver Catarina com imóveis na planta em Balneário Camboriú. Compare lançamentos, apartamentos e casas, veja plantas, preços e fale com corretores credenciados.';
