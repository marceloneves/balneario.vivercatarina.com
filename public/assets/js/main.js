(function ($) {
  ...
  $(window).on("load", function () {
    ...
    $.fn.thmobilemenu = function (options) {
        ...
        return this.each(function () {
            ...
            // Hide Menu On outside click (ignore real navigation links)
            menu.on("click", function (e) {
                if ($(e.target).closest("a[href]").length) {
                    var href = $(e.target).closest("a[href]").attr("href") || "";
   ...
   $(".th-slider").each(function () {
    ...
    var paginationEl2 = thSlider.find(".slider-pagination2").get(0); // Custom number display
    ...
    var sliderDefault = {
        ...
        on: {
            init: function () {
                ...
                // Update progress number for progressbar
                if (thSlider.find('.progress-number').length) {
                    const numberEl = thSlider.find('.progress-number span:first-child')[0];
                    const totalEl = thSlider.find('.progress-number span:last-child')[0];
                    if (numberEl && totalEl) {
            ...
            slideChange: function () {
                ...
                if (thSlider.find('.progress-number').length) {
                    ...
                    const totalEl = thSlider.find('.progress-number span:last-child')[0];
                    if (numberEl && totalEl) {
                        numberEl.textContent = realIndex < 10 ? "0" + realIndex : realIndex;
    ...
    // Optional: Panorama effect for images
    thSlider.find('.swiper-slide').each(function () {
        ...
        if (image.length) {
            ...
            var viewerContainer = slide.find('.explore-single-slide, .box-img, .propery-single-slide').get(0);
            ...
            if (viewerContainer) {
                ...
                // Disable swiper interactions when panorama is active
    ...
    $.fn.magnificPopup && $(".popup-image").magnificPopup({
        type: "image",
    ...
    $(document).ready(function() {
        $.fn.magnificPopup && $('.popular-popup-image').magnificPopup({
            type: 'image',
            gallery: {
                enabled: true 
            }
    ...
    $.fn.magnificPopup && $(".popup-video").magnificPopup({
        type: "iframe",
    });

    /* magnificPopup video view */
    $.fn.magnificPopup && $(".popup-content").magnificPopup({
        type: "inline",
        midClick: true,
    });
    ...
    if ($(postionHandler).length) {
        $.fn.imagesLoaded && $(postionHandler).imagesLoaded(function () {
            $(postionHandler).sectionPosition("data-sec-pos", "data-pos-for");
        });
    }

    /*----------- 14. Filter ----------*/
    $.fn.imagesLoaded && $(".filter-active").imagesLoaded(function () {
        var $filter = ".filter-active",
            $filterItem = ".filter-item",
            $filterMenu = ".filter-menu-active";

        if ($($filter).length > 0) {
            var $grid = $.fn.isotope && $($filter).isotope({
    ...
    $.fn.imagesLoaded && $(".masonary-active, .woocommerce-Reviews .comment-list").imagesLoaded(
        function () {
            var $filter =
    ...
    /*----------- 14. Counter Up ----------*/
    $.fn.counterUp && $(".counter-number").counterUp({
        delay: 10,
        time: 1000,
    });
  ...
  /*---------- Service active class and remove ----------*/

$(".service-1-offer-item").on("click", function () {
    $(".service-1-offer-item").removeClass("active");
    $(this).addClass("active");
});
